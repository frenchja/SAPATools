...
AspectNorms <- function(x,aspect=ALL) {
  ...
  # Args:
  #	  x:		SAPA data.frame
  #   aspect:	ALL, assertiveness, balance, boldness, sociability, compassion,
  #				honesty, humility, industry, intellect, openness, orderliness,
  #				politeness
  #
  ...
  assertivenessNorms <- function(x){
  	...
  	return(c(AssertivenessItemMeans,AssertivenessItemSDs))
  }
  setTxtProgressBar(pb, 1)
  balanceNorms <- function(x){
  	...
  	return(c(BalanceItemMeans,BalanceItemSDs))
  }
  setTxtProgressBar(pb, 2)
  boldnessNorms <- function(x){
  	...
  	return(list("BoldnessItemMeans"=BoldnessItemMeans,
  		"BoldnessItemSDs"=BoldnessItemSDs))
  }
  compassionNorms <- function(x){
  	...
  	return(list("CompassionItemMeans"=CompassionItemMeans,
  		"CompassionItemSDs"=CompassionItemSDs))
  }
  socialbilityNorms <- function(x){
  	...
  	return(c(SociabilityItemMeans,SociabilityItemSDs))
  }
  honestyNorms <- function(x){
  	...
  	return(c(HonestyItemMeans,HonestyItemSDs))
  }
  humilityNorms <- function(x){
	...
	return(c(HumilityItemMeans,HumilityItemSDs))
  }
	industryNorms <- function(x){
		...
		return(c(IndustryItemMeans,IndustryItemSDs))
	}
	intellectNorms <- function(x){
		...
		return(c(IntellectItemMeans,IntellectItemSDs))
	}
	opennessNorms <- function(x){
		...
		return(c(OpennessItemMeans,OpennessItemSDs))
	}
	orderlinessNorms <- function(x){
		...
		return(c(OrderlinessItemMeans,OrderlinessItemSDs))
	}
	politenessNorms <- function(x){
		...
		return(c(PolitenessItemMeans,PolitenessItemSDs))
	}
  switch(aspect,
  		ALL={
  			assertivenessNorms(x)
  			balanceNorms(x)
  			boldnessNorms(x)
  			compassionNorms(x)
  			socialbilityNorms(x)
